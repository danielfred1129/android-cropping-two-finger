...
//                                                    xMiddle + heightWidth,
//                                                    top + heightHeight);
                    mResizeDrawableHeight.setBounds(right - heightWidth,
                            top - heightHeight,
                            right + heightWidth,
                            top + heightHeight);
...
//                                                    xMiddle + heightWidth,
//                                                    bottom + heightHeight);
                    mResizeDrawableHeight.setBounds(left - heightWidth,
                            bottom - heightHeight,
                            left + heightWidth,
                            bottom + heightHeight);
                    mResizeDrawableHeight.draw(canvas);
...
//        // the cropping rectangle.
        ...
        if (dx > 0F && r.width() + dx > mImageRect.width()) {
            float adjustment = (mImageRect.width() - r.width());
            dx = adjustment;
            if (mMaintainAspectRatio) {
                dy = dx / mInitialAspectRatio;
            }
        }
        if (dy > 0F && r.height() + dy > mImageRect.height()) {
            float adjustment = (mImageRect.height() - r.height());
            dy = adjustment;
            if (mMaintainAspectRatio) {
                dx = dy * mInitialAspectRatio;
            }
